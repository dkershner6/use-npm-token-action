...
describe('createNpmrc', () => {
    it('Should create a file in the standard location with the correct token', () => {
        createNpmrc('TESTTOKEN', DEFAULT_WORKSPACE);
    ...
    it('Should create a file in a different location with the correct token', () => {
        const aDifferentLocation = './node';

        createNpmrc('TESTTOKEN', aDifferentLocation);
